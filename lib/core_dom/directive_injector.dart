...
class DirectiveInjector implements DirectiveBinder {
  ...
  _getDirectiveByKey(Key k, int visType, int d, Injector i) {
    do {
    ...
    switch (visType) {
      ...
      case VISIBILITY_DIRECT_CHILD:           return parent._getDirectiveByKey(k, VISIBILITY_LOCAL, d, i);
      case VISIBILITY_CHILDREN:               return parent._getDirectiveByKey(k, VISIBILITY_CHILDREN, d, i);
      // SHADOW
      case VISIBILITY_COMPONENT_LOCAL:        return parent._getDirectiveByKey(k, VISIBILITY_LOCAL, d, i);
      case VISIBILITY_COMPONENT_DIRECT_CHILD: return parent._getDirectiveByKey(k, VISIBILITY_DIRECT_CHILD, d, i);
      case VISIBILITY_COMPONENT_CHILDREN:     return parent._getDirectiveByKey(k, VISIBILITY_CHILDREN, d, i);
      default: throw null;
    }
  }
...
abstract class ComponentDirectiveInjector extends DirectiveInjector {
  ...
  _getDirectiveByKey(Key k, int visType, int d, Injector i) =>
      super._getDirectiveByKey(k, visType + VISIBILITY_COMPONENT_OFFSET, d, i);
}
