...
class DirectiveInjector implements DirectiveBinder {
  ...
  Object _getByKey(Key key, int depth) {
    ...
    return isDirective ? _getDirectiveByKey(key, uid, depth + 1, appInjector) : _getById(uid);
  }

  _getDirectiveByKey(Key k, int visibility, int depth, Injector i) {
    do {
      if (_key0 == null) break; if (identical(_key0, k)) return _obj0 == null ?  _obj0 = _new(_pKeys0, _factory0, depth) : _obj0;
      if (_key1 == null) break; if (identical(_key1, k)) return _obj1 == null ?  _obj1 = _new(_pKeys1, _factory1, depth) : _obj1;
      if (_key2 == null) break; if (identical(_key2, k)) return _obj2 == null ?  _obj2 = _new(_pKeys2, _factory2, depth) : _obj2;
      if (_key3 == null) break; if (identical(_key3, k)) return _obj3 == null ?  _obj3 = _new(_pKeys3, _factory3, depth) : _obj3;
      if (_key4 == null) break; if (identical(_key4, k)) return _obj4 == null ?  _obj4 = _new(_pKeys4, _factory4, depth) : _obj4;
      if (_key5 == null) break; if (identical(_key5, k)) return _obj5 == null ?  _obj5 = _new(_pKeys5, _factory5, depth) : _obj5;
      if (_key6 == null) break; if (identical(_key6, k)) return _obj6 == null ?  _obj6 = _new(_pKeys6, _factory6, depth) : _obj6;
      if (_key7 == null) break; if (identical(_key7, k)) return _obj7 == null ?  _obj7 = _new(_pKeys7, _factory7, depth) : _obj7;
      if (_key8 == null) break; if (identical(_key8, k)) return _obj8 == null ?  _obj8 = _new(_pKeys8, _factory8, depth) : _obj8;
      if (_key9 == null) break; if (identical(_key9, k)) return _obj9 == null ?  _obj9 = _new(_pKeys9, _factory9, depth) : _obj9;
    } while (false);

    switch (visibility) {
      case VISIBILITY_LOCAL:                  return appInjector.getByKey(k, depth);
      case VISIBILITY_DIRECT_CHILD:           return parent._getDirectiveByKey(k, VISIBILITY_LOCAL, depth, i);
      case VISIBILITY_CHILDREN:               return parent._getDirectiveByKey(k, VISIBILITY_CHILDREN, depth, i);
      // Components
      case VISIBILITY_COMPONENT_LOCAL:        return parent._getDirectiveByKey(k, VISIBILITY_LOCAL, depth, i);
      case VISIBILITY_COMPONENT_DIRECT_CHILD: return parent._getDirectiveByKey(k, VISIBILITY_DIRECT_CHILD, depth, i);
      case VISIBILITY_COMPONENT_CHILDREN:     return parent._getDirectiveByKey(k, VISIBILITY_CHILDREN, depth, i);
      default: throw "Visibility $visibility is not supported";
    }
  }
  ...
  dynamic _new(List<Key> paramKeys, Function fn, int depth) {
    var oldTag = _TAG_GET.makeCurrent();
    ...
    if (size > 15) {
      ...
      var a01 = size >= 01 ? _getByKey(paramKeys[00], d1) : null;
      var a02 = size >= 02 ? _getByKey(paramKeys[01], d1) : null;
      var a03 = size >= 03 ? _getByKey(paramKeys[02], d1) : null;
      var a04 = size >= 04 ? _getByKey(paramKeys[03], d1) : null;
      var a05 = size >= 05 ? _getByKey(paramKeys[04], d1) : null;
      var a06 = size >= 06 ? _getByKey(paramKeys[05], d1) : null;
      var a07 = size >= 07 ? _getByKey(paramKeys[06], d1) : null;
      var a08 = size >= 08 ? _getByKey(paramKeys[07], d1) : null;
      var a09 = size >= 09 ? _getByKey(paramKeys[08], d1) : null;
      var a10 = size >= 10 ? _getByKey(paramKeys[09], d1) : null;
      var a11 = size >= 11 ? _getByKey(paramKeys[10], d1) : null;
      var a12 = size >= 12 ? _getByKey(paramKeys[11], d1) : null;
      var a13 = size >= 13 ? _getByKey(paramKeys[12], d1) : null;
      var a14 = size >= 14 ? _getByKey(paramKeys[13], d1) : null;
      var a15 = size >= 15 ? _getByKey(paramKeys[14], d1) : null;
      _TAG_INSTANTIATE.makeCurrent();
      switch(size) {
...
abstract class ComponentDirectiveInjector extends DirectiveInjector {
  ...
  _getDirectiveByKey(Key k, int visibility, int depth, Injector i) =>
      super._getDirectiveByKey(k, visibility + VISIBILITY_COMPONENT_OFFSET, depth, i);
}
...
class DefaultDirectiveInjector extends DirectiveInjector {
  ...
  _getDirectiveByKey(Key key, int visType, int depth, Injector i) =>
      parent == null ? i.getByKey(key, depth) : parent._getDirectiveByKey(key, visType, depth, i);
