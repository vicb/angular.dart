...
void main() {
  describe('WatchGroup', () {
    ...
    it('should have a toString for debugging', () {
      ...
      watchGrp.newGroup(new DynamicObject());
    ...
    describe('property chaining', () {
      ...
      it('should read property chain', () {
        context.a = new DynamicObject()..b = 'hello';
      ...
      it('should reuse handlers', () {
        var user1 = new DynamicObject();
        user1..first = 'misko'..last='hevery';
        var user2 = new DynamicObject();
        user2..first = 'misko'..last='Hevery';
      ...
      it('should eval pure FunctionApply', () {
        context.a = new DynamicObject()..val = 1;
      ...
      it('should eval pure function', () {
        context.a = new DynamicObject()..val = 1;
        context.b = new DynamicObject()..val = 2;
      ...
      it('should eval chained pure function', () {
        context.a = new DynamicObject()..val =  1;
        context.b = new DynamicObject()..val =  2;
        context.c = new DynamicObject()..val =  3;
    ...
    describe('evaluation', () {
      ...
      it('should support custom context', () {
        expect(eval('x', new _Context(42))).toBe(42);
        expect(eval('x', new _Context(87))).toBe(87);
      });
